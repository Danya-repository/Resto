      ...
      <div class="collage__inner">
        ...
        <aside class="collage__info">
          <div class="collage__info-slide">
            <p class="collage__info-title subtitle">Картофельный суп с креветками и икрой палтуса 1
            </p>
          ...
          <div class="collage__info-slide">
            <p class="collage__info-title subtitle">Холодный суп 2
            </p>
          ...
          <div class="collage__info-slide">
            <p class="collage__info-title subtitle">Молочный суп 3 
            </p>
          ...
          <div class="collage__info-slide">
            <p class="collage__info-title subtitle">Сладкий суп 4 
            </p>
          ...
          <div class="collage__info-slide">
            <p class="collage__info-title subtitle">Картофельный суп с креветками и икрой палтуса 5 
            </p>
            <p class="collage__info-text">Крем-супы являются основой современной кулинарии. Они предоставляют
              поварам огромные возможности по проявлению творчества и демонстрации мастерства. Картофельный суп с
              креветками и икрой палтуса является одним из наиболее ярких порождений кулинарных фантазий на тему
