class Basket {
    ...
    removeItem(id) {
        ...
        this.updateCoundAndDiscount()
  }
    addItem(id, {name, price, imgUrl, count}) {
        ...
        let basketProductListItem = `<li class="order-panel__item" data-id-in-basket=${id}>
                                    ...
                                    <div class="order-panel__item-bottom">
                                      ...
                                      <button class='order-panel__item-remove-btn' onclick="basket.removeItem(${id}); basketButton.render()">
