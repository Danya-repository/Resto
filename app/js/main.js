...
class Product {
    ...
    constructor(productParamsObj) {
        this.id = productParamsObj.id
        this.type = productParamsObj.type;
        this.price = productParamsObj.price;
        this.name = productParamsObj.name;
        this.weight = productParamsObj.weight;
        this.imgUrl = productParamsObj.imgUrl;
...
//         const basket = document.createElement('div')
//         basket.classList.add('header__order-panel', 'order-panel')
//         basket.innerHTML += `<h3 class="order-panel__title subtitle">Заказ #34562</h3>
//                              <ul class="order-panel__status-bar">
//                                <li class="order-panel__status">Формируется</li>
//                                <li class="order-panel__status">Готовится</li>
//                                <li class="order-panel__status">В пути</li>
//                              </ul>
//                              <div class="order-panel__item-list-titles">
//                                <h4 class="order-panel__item-list-title title-pos">Позиция</h4>
//                                <h4 class="order-panel__item-list-title">Количество</h4>
...
//                                  <div class="order-total-info__value">3425</div>
//                                </div>
//                              </div>
//                              <button class="order__submit" type="submit">
//                                Завершить покупку
