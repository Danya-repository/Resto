...
class Products {
    ...
    render() {
      ...
      const place = document.querySelector(`.${this.type}__list`)
      let htmlCatalog = ``;
      let CATALOG = [];
      ...
      for (let id in listOfProductsInLocalStorage) {
        ...
        basketProductListHtml += `<li class="order-panel__item">
                                    ...
                                    <div class="order-panel__item-bottom">
                                      ...
                                      <button class='order-panel__item-remove-btn' onclick="basket.removeProductFromBasket(${id}); ${classInstanceName}.removeProductFromOrdered(${id})">
